...
<div class="layui-row">
    ...
    <div class="layui-card">
            ...
            <div class="layui-card-body">
                <form class="layui-form" action="${pageContext.request.contextPath}/admin/StoreServlet?act=save" method="post">
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-inline">
                            <input type="date" name="producedate"  value="${t.producedate}" lay-verify="required" class="layui-input" />
                        </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
